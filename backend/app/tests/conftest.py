...
async def sample_b2b_leads(
    ...
    leads = [
        b2b_lead.B2BLead(
            ...
            contact_twitter="lightingcorp",
            data_source="google_search",
            source_url="https://example.com/company/test",
            status="uncontacted",
            created_at=now,
        ),
        b2b_lead.B2BLead(
            ...
            contact_linkedin="https://linkedin.com/company/brightlights",
            data_source="osm",
